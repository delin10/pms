...
//	public static String REQ_METHOD_TRACE = "TRACE";
	...
	public DWebClient(String address) throws KeyManagementException, NoSuchAlgorithmException, IOException{
	...
	public String post() throws Exception{
		...
		return post(URLEncoder.encode(pstr,"UTF-8"));
	}
	...
	public DWebClient addParam(String key ,String val){
